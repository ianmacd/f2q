...
#define QWLAN_VERSION_EXTRA            "Q-HS200723B"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSION_EXTRA            "Q-HP200723B"
#else
...
#if defined(QCA_WIFI_QCA6390) //Hastings
#define QWLAN_VERSIONSTR               "5.2.022.2Q-HS200723B"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSIONSTR               "5.2.022.2Q-HP200723B"
#else
